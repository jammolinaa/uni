...
<form action="{{route('actualizar_profesor',$profesor)}}" method="POST"
enctype="multipart/form-data">
@csrf
@method('put')
<div class="md-3 row">
  <label for="matricula" class="col-sm-2 col-form-label">Cedula:</label>
  <div class="col-sm-5">
    <input type="text" class="form-control" name="cedula" id="cedula" value="{{$profesor->cedula}}" required>
   </div>
 </div>
 ...
 <div class="md-3 row">
   ...
   <div class="col-sm-5">
     ...
     <div class="md-3 row">
       ...
       <div class="col-sm-5">
         <input type="text" class="form-control" name="edad" id="edad" value="{{$profesor->edad  }}" required>
       </div>
     </div>
       ...
       <div class="md-3 row">
         ...
         <div class="md-3 row">
          ...
          <div class="col-sm-5">
            <input type="password" class="form-control" name="contraseña" id="contraseña" value="{{$profesor->contraseña  }}" required>
          </div>
          <div class="md-3 row">
            <div class="col-sm-5">
         <button type="submit">enviar</button>
         <button  href="{{route('tablas_profesor')}}"type="submit">Atras</button>
