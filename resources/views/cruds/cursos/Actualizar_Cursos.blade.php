...
<form action="{{ route('actualizar_cursos',$cursos) }}" method="POST"style="">
    ...
    @method('put')
                          ...
                          <div class="col-sm-5">
                            <input type="text" class="form-control" name="Curso" id="Curso" value="{{$cursos->Curso}}" required>
                        ...
                        <option value="{{$cursos->Programa_id}}">{{$cursos->programa->programa}}</option>
                         ...
                         @endforeach
                          ...
                          <div class="col-sm-5">
                            ...
                            <option value="{{$cursos->Profesor_id}}">{{$cursos->profesor->nombre}} </option>
